...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on Hermes Agent (by Nous Research). Docs: "
    "https://hermes-agent.nousresearch.com/docs (authoritative source of truth). "
    "The `hermes-agent` skill (loaded via skill_view) has the actual CLI commands "
    "for configuration, setup, and troubleshooting — load it first for any Hermes "
    "feature question."
)
...
MEMORY_GUIDANCE = (
    ...
    "If a fact will be stale in 7 days (PR numbers, commit SHAs, 'Phase N done', file "
    "counts), it does not belong in memory. "
...
def _build_skills_system_prompt_inner(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "load them even for tasks you already know how to do.\n"
            "For any Hermes Agent configuration/setup/troubleshooting question, load the "
            "`hermes-agent` skill first (it has the actual CLI commands).\n"
